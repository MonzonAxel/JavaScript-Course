/*
    API webStorage:
        ...
        Ambos funcionan con clave:valor donde el valor es una cadena de texto y tienen dos métodos fundamentales setItem() para asignar una clave:valor ( es decir guardando la informacion) y getItem() que recibe como parámetro la clave de la que quieremos obtener el valor.
*/

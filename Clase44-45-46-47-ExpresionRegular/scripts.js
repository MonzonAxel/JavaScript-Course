/*
    ...
    Comodines:
        ...
        -Rangos: Entre corchetes si ponemos un guión entre dos caracteres establecemos un rango. [a-z] Todas las letras minúsculas de la a hasta la z. Esto lo hace segun la tabla de caracteres de ASCII ( no sobre el alfabeto )
        ...
        -Cadenas completas:
            Para establecer una cadena completa debe ir entre paréntesis, si queremos más palabras irán separadas por un pipe. (lorem|amet) busca palabra completa , recordar que si dejo espacios , tambien los va a tener en cuenta. 
